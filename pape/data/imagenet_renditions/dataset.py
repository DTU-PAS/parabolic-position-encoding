...
RENDITION_ID_TO_INDEX = {IMAGENET_IDS[i]: i for i in range(1000) if IMAGENET_IDS[i] in IMAGENET_RENDITIONS_IDS}


class ImageNetRenditionsDataset(torch.utils.data.Dataset):
    def __init__(self, size: tuple[int, int]):
        source_dir = get_dataset_dir("imagenet-renditions")
        ...
        for class_dir in source_dir.iterdir():
            if not class_dir.is_dir():
                continue
            label = RENDITION_ID_TO_INDEX[class_dir.name]
